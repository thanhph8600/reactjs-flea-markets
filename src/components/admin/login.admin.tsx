...
import { validePassword, validePhone, setToken, removeToken } from '../../util'
            ...
            .then(res => {
                ...
                if (res.data.access_token) {
                    ...
                    requestApi('auth/profile', 'GET', {}).then(res => {
                        ...
                        toast.error("Không thể truy cập vào trang này!");
                        setLoader(false);
                    })
                }
            }).catch(err => {
    ...
    return (
        <>
            <div className="bg-gray-100 min-h-screen flex flex-col px-6 py-6 lg:px-8">
                ...
                <img className='w-[100px] h-[100px] border shadow m-auto rounded-full object-cover' src="https://tranhtomaudep.com/wp-content/uploads/2023/09/to-mau-khung-canh-cho-ben-thanh.jpg" alt="" />
