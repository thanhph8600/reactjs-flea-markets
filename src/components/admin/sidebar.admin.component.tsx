        ...
        <div className="p-4 border-2 shadow-lg h-screen fixed top-0 left-0 text-gray-700"  >
            <div>
                ...
                <div className="flex flex-col gap-6 w-48 m-auto">
                    ...
                    <Link to="/admin/customer" className='  font-semibold hover:text-gray-900 flex gap-2 items-center'>Khách hàng <FaUsers /> </Link>
                    <Link to="/admin/category" className='  font-semibold hover:text-gray-900 flex gap-2 items-center'>Danh mục <BiSolidCategory /> </Link>
                    <Link to="/admin/product" className='  font-semibold hover:text-gray-900 flex gap-2 items-center'>Sản phẩm <FaListUl /> </Link>
                </div>
            </div>
        </div>
    )
