...
<div className="flex items-center justify-center min-h-screen bg-white py-24">
    <div className="flex flex-col">
        ...
        <div className=" flex justify-center pt-12 ">
            <p onClick={()=>goBack()} className="border cursor-pointer rounded-lg py-2 hover:bg-gray-100 hover:text-gray-600 px-10 text-gray-400 font-medium text-sm md:text-xl">Quay lại trang trước</p>
        </div>
